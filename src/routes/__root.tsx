...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `${club.name} — ${club.short}, basket à ${club.city}` },
      {
        name: "description",
        content: `Site officiel du ${club.name} : formation et École de Basket à ${club.city}, ${club.department}.`,
      },
      { name: "author", content: club.name },
